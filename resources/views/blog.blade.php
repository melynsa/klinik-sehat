            ...
            <div class="container" data-scrollax-parent="true">
                <div class="row slider-text align-items-end">
                    <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                        ...
                        <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Read Our Blog
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        @if ($post->status == 'diverifikasi')
                            <div class="col-md-12 ftco-animate">
                                <div class="blog-entry">
                                    <a href="blog-single.html" class="block-20"
                                        style="background-image: url({{ asset('pasien/foto/'.$post->gambar) }});">
                                    </a>
                                    <div class="text d-flex py-4">
                                        <div class="meta mb-3">
                                            <div><a href="#">{{ $post->tglrilis }}</a></div>
                                        ...
                                        <div class="desc pl-sm-3 pl-md-5">
                                            ...
                                            <p>{{Str::words($post->deskripsi, 30, '...')}}
                                            </p>
                                            <p><a href="{{ route('dblog.page', $post->id) }}" class="btn btn-primary btn-outline-primary">Read
                                                    more</a></p>
                                        </div>
                                    </div>
                                </div>
