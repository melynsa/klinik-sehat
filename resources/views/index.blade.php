    ...
    <section class="ftco-section ftco-services">
      <div class="container">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <a href="/service"><button style="background-color: #52b7dc; padding: 10px 50px; color: white; border-radius: 5px; border: none;margin-top: 20px;cursor: pointer;">Layanan Lainnya</button></a>
        </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
                <img src="{{ asset('upload/'.$itemKategori->gambar) }}" style="width: 80px; height: auto;"  alt="">
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    <div class="img mb-4" style="background-image: url({{ asset('pasien/foto/'.$profil->gambar) }});"></div>
                    <div class="info text-center">
                        ...
                        <div class="text">
                            ...
                            <ul class="ftco-social">
                                <li class="ftco-animate"><a href="{{$profil->twiter}}"><span class="icon-twitter"></span></a></li>
                                <li class="ftco-animate"><a href="{{$profil->insta}}"><span class="icon-facebook"></span></a></li>
                                <li class="ftco-animate"><a href="{{$profil->face}}"><span class="icon-instagram"></span></a></li>
                                <li class="ftco-animate"><a href="{{$profil->google}}"><span class="icon-google-plus"></span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20" style="background-image: url({{ asset('pasien/foto/'.$post->gambar) }});"></a>
          ...
          <div class="col-md-4 pr-md-4">
            ...
            @foreach ($blog as $post)
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url({{ asset('pasien/foto/'.$post->gambar) }});"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">{{ $post->judul }}</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span>{{$post->tglrilis}}</a></div>
